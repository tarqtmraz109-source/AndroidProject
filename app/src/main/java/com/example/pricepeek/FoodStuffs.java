...
public class FoodStuffs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_stuffs);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.foodStuffsPage), (v, insets) -> {
    ...
    private void setupProductList() {
        ...
        adapter = new ProductAdapter(items, product -> {
            Intent intent = new Intent(FoodStuffs.this, PrudectDetails.class);
